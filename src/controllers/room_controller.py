...
def select_all_available(location, capacity, begin, end, equipment, room_type, province):
    connexion = Database.get_connection()
    cursor = connexion.cursor()
    ...
    if province is not None:
        province_sql = " AND r.province = '" + province + "'"
        sql += province_sql
    # if (len(location)):
    #     print(location)
    #     location_sql = ' AND r.name like ' + location
    #     sql += location_sql 
